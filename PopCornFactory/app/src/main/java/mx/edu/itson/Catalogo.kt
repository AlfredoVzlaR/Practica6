...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Friends", R.drawable.friends, R.drawable.friendsheader, "Follow the lives of six reckless adults living in Manhattan, as they indulge in adventures which make their lives both troublesome and happening.",arrayListOf<Cliente>()))
